...
internal object DebugUsbAdbCommands {
    ...
    private suspend fun ensureConnected(
        ...
        intent: Intent,
    ): Pair<com.screen.remote.android.infrastructure.adb.usb.UsbDeviceInfo, String> {
        val device = resolveUsbDevice(intent) ?: error("no matching usb adb device found")
        log(
    ...
    private suspend fun resolveUsbDevice(intent: Intent): com.screen.remote.android.infrastructure.adb.usb.UsbDeviceInfo? {
    ...
    private fun buildUsbDeviceId(device: com.screen.remote.android.infrastructure.adb.usb.UsbDeviceInfo): String {
