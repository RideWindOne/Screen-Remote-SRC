...
internal suspend fun initializeAudioCodecSelectorTts(context: android.content.Context) {
    if (!com.mobile.scrcpy.android.core.common.manager.TTSManager.isReady()) {
        com.mobile.scrcpy.android.core.common.manager.TTSManager.init(context, showToast = true)
        var waitCount = 0
        while (!com.mobile.scrcpy.android.core.common.manager.TTSManager.isReady() && waitCount < 50) {
