...
internal class ScrcpyMonitorStateReducer {
    ...
    private fun Map<com.screen.remote.android.infrastructure.scrcpy.session.model.SocketType, SocketStatistics>.updated(
        socketType: com.screen.remote.android.infrastructure.scrcpy.session.model.SocketType,
        transform: (SocketStatistics) -> SocketStatistics,
    ): Map<com.screen.remote.android.infrastructure.scrcpy.session.model.SocketType, SocketStatistics> {
