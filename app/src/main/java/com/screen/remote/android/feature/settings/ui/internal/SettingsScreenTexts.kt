...
internal data class SettingsScreenTexts(
    ...
    val helpAllowScreenCapture: String,
...
internal fun rememberSettingsScreenTexts(): SettingsScreenTexts =
    SettingsScreenTexts(
        ...
        allowScreenCapture = rememberText(SettingsTexts.SETTINGS_ALLOW_SCREEN_CAPTURE),
        ...
        helpAllowScreenCapture = rememberText(SettingsTexts.HELP_ALLOW_SCREEN_CAPTURE),
