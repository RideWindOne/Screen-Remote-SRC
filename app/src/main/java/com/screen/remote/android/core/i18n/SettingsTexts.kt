...
object SettingsTexts {
    ...
    val SETTINGS_CUSTOM_COMMANDS = TextPair("自定义命令", "Custom Commands")
    val SETTINGS_CUSTOM_COMMANDS_HELP =
        TextPair("全局管理 Shell 页面的快捷命令。", "Manage quick commands used globally on the Shell page.")
    ...
    val CUSTOM_COMMAND_EDIT = TextPair("编辑命令", "Edit Command")
    val CUSTOM_COMMAND_NAME = TextPair("名称", "Name")
