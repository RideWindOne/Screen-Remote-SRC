...
object SessionTexts {
    ...
    val SESSION_CONFIRM_DELETE_MESSAGE = TextPair(
        "确定要删除会话 \"%s\" 吗？", "Are you sure you want to delete session \"%s\"?"
    )
    ...
    val SESSION_RESET_CONNECTION_SUCCESS = TextPair(
    ...
    val SESSION_RESET_CONNECTION_FAILED = TextPair("重置会话连接失败", "Failed to reset the session connection")
    val LATENCY_TEST_ENTRY = TextPair("连接延迟测试", "SpeedTest")
    val LATENCY_TEST_HELP = TextPair(
    ...
    val ONBOARDING_RESOLUTION_BODY = TextPair(
    ...
    val ONBOARDING_FPS_BODY = TextPair(
    ...
    val ONBOARDING_CODEC_BODY = TextPair(
    ...
    val ONBOARDING_FLOATING_BALL_DESCRIPTION = TextPair(
    ...
    val ONBOARDING_FLOATING_BALL_TAP_BODY = TextPair(
        "点击打开快捷菜单，拖动可调整悬浮球位置。",
    ...
    val ONBOARDING_FLOATING_BALL_SWIPE_BODY = TextPair(
    ...
    val ONBOARDING_FLOATING_BALL_SCREENSHOT_BODY = TextPair(
        "保持长按不移动，可截取远程设备屏幕。",
    ...
    val ONBOARDING_ADVANCED_DESCRIPTION = TextPair(
    ...
    val ONBOARDING_PORT_FORWARD_BODY = TextPair(
    ...
    val ONBOARDING_VIRTUAL_DISPLAY_BODY = TextPair(
    ...
    val ONBOARDING_GAME_MODE_BODY = TextPair(
    ...
    val ONBOARDING_DISCOVERY_BODY = TextPair(
    ...
    val ONBOARDING_APPS_BODY = TextPair(
        "查看应用信息，并执行常用的应用管理操作。", "Inspect installed apps and run common app-management actions."
    )
    val ONBOARDING_FILES_TITLE = TextPair("文件与进程", "Files & processes")
    val ONBOARDING_FILES_BODY = TextPair(
    ...
    val ONBOARDING_SHELL_BODY = TextPair(
    ...
    val SECTION_START_APP = TextPair("启动 App", "Start App")
    ...
    val LABEL_SHELL_PASSWORD = TextPair("Shell 密码", "Shell Password")
    ...
    val SWITCH_IGNORE_VIDEO_ENCODER_CONSTRAINTS = TextPair("忽略视频编码器约束", "Ignore Video Encoder Constraints")
    ...
    val PLACEHOLDER_SHELL_PASSWORD = TextPair("可选", "Optional")
    ...
    // 帮助说明文本
    val HELP_SESSION_NAME = TextPair(
    ...
    val HELP_CONNECTION_ENDPOINTS = TextPair(
    ...
    val HELP_SELECT_GROUP = TextPair(
    ...
    val HELP_GAME_MODE_FULL_SCREEN_DISABLED = TextPair(
    ...
    val HELP_USE_FULL_SCREEN = TextPair(
    ...
    val HELP_SHOW_FLOATING_BALL = TextPair(
    ...
    val HELP_ENABLE_HARDWARE_DECODING = TextPair(
    ...
    val HELP_COMPATIBILITY_MODE = TextPair(
    ...
    val HELP_USE_ADB_FORWARD = TextPair(
    ...
    val HELP_GAME_MAX_FPS = TextPair(
    ...
    val HELP_NORMAL_MAX_SIZE = TextPair(
    ...
    val HELP_COMPATIBILITY_QUALITY = TextPair(
    ...
    val HELP_NORMAL_VIDEO_BITRATE = TextPair(
    ...
    val HELP_NORMAL_MAX_FPS = TextPair(
    ...
    val HELP_VIDEO_ENCODER = TextPair(
    ...
    val HELP_VIDEO_DECODER = TextPair(
    ...
    // 音频配置
    val HELP_ENABLE_AUDIO = TextPair(
    ...
    val HELP_AUDIO_ENCODER = TextPair(
    ...
    // 其他选项
    val HELP_CLIPBOARD_SYNC = TextPair(
    ...
    val HELP_TURN_SCREEN_OFF = TextPair(
    ...
    val HELP_POWER_OFF_ON_CLOSE = TextPair(
    ...
    val HELP_CLEANUP_ON_DISCONNECT = TextPair(
    ...
    val HELP_KEEP_DEVICE_AWAKE = TextPair(
    ...
    val HELP_IGNORE_VIDEO_ENCODER_CONSTRAINTS = TextPair(
    ...
    val HELP_VIRTUAL_DISPLAY_SYSTEM_DECORATIONS = TextPair(
    ...
    val HELP_PRESERVE_VIRTUAL_DISPLAY_CONTENT = TextPair(
