...
internal class VideoCodecSelectorState(
    ...
    var featureFilter by mutableStateOf("")
        private set
    ...
    fun updateFeatureFilter(value: String) {
        featureFilter = value
    }
...
@Composable
internal fun rememberVideoCodecSelectorState(currentCodecName: String?): VideoCodecSelectorState =
    remember(currentCodecName) { VideoCodecSelectorState(currentCodecName) }
